...
void printListOfSupportedSystems() {
    // printing List of systems
    
    const char* supportedSystems[] = {
        "RZ-104-11",
        "RZ-104-12"
    };

    // Calculate the number of elements in the array
    size_t numSystems = sizeof(supportedSystems) / sizeof(supportedSystems[0]);

    // Iterate through the array and print each system
...
double RRED_RZ_300_HDR(double Flow, double UVT, double P, double Eff, double D1Log, uint32_t NLamps) {
    // The function is for HDR validation model

    bool legacy = false; // legacy RED function

    // Dose Coefficents:
    double a = 1.9723460342;
    double b = 1.1342181946;
    double c = -0.89447843101;
    double d = 1.6521724013;
    double e = 0.1018468648;
    double f = -0.0060928379303;
    double g = 1.1855262222;
